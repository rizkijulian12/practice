<div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?= base_url('pinjaman_harian_kls/proses_ubah/'.$record->id.'/'.$this->uri->segment(4).'/'.$this->uri->segment(5)) ?>" method="post">
              <div class="box-body">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="tgl_mengembalikan" name="jumlah_buku" value="<?= $record->jlh_buku; ?>">
                </div>
                </div>
