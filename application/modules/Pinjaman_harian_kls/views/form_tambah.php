<div class="col-md-12">
        ...
        <form class="form-horizontal" action="<?= base_url('pinjaman_harian_kls/proses_tambah/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="exampleInputFile" class="col-sm-2 control-label">Jumlah Buku</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="kelas" name="jumlah_buku" placeholder="Jumlah Buku" required>
                  </div>
                  </div>
              ...
              <div class="box-footer">
                <a href="<?= base_url('pinjaman_harian_kls')?>"><input type="button" class="btn btn-default pull-left" value="Batalkan"></a>
