<div class="col-md-12">
        ...
        <form class="form-horizontal" action="<?= base_url('kelas_viii/proses_tambah/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="box-footer">
                <a href="<?= base_url('kelas_viii')?>"><input type="button" class="btn btn-default pull-left" value="Batalkan"></a>
