...
<head>
  ...
  <title>Kulineran - User</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="icon" type="image/png" href="<?= base_url()?>images/kulineran.png">
  <!-- Bootstrap 3.3.7 -->
...
<?php $this->load->view('partials/header_user'); ?>

<?php $this->load->view('partials/navigasi_user'); ?>
